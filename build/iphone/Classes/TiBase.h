...
// in simulator we redefine to format for _titanium_list_app_list_app Developer console
...
{\
	NSString * exceptionName = [@"org.titanium_list_app." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titanium_list_app";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UI_titanium_list_app_list_appNativeItemNone = -1, 
	UI_titanium_list_app_list_appNativeItemSpinner = -2,
	UI_titanium_list_app_list_appNativeItemProgressBar = -3,
	
	UI_titanium_list_app_list_appNativeItemSlider = -4,
	UI_titanium_list_app_list_appNativeItemSwitch = -5,
	UI_titanium_list_app_list_appNativeItemMultiButton = -6,
	UI_titanium_list_app_list_appNativeItemSegmented = -7,
	
	UI_titanium_list_app_list_appNativeItemTextView = -8,
	UI_titanium_list_app_list_appNativeItemTextField = -9,
	UI_titanium_list_app_list_appNativeItemSearchBar = -10,
	
	UI_titanium_list_app_list_appNativeItemPicker = -11,
	UI_titanium_list_app_list_appNativeItemDatePicker = -12,
	
	UI_titanium_list_app_list_appNativeItemInfoLight = -13,
	UI_titanium_list_app_list_appNativeItemInfoDark = -14,
	
	UI_titanium_list_app_list_appNativeItemDisclosure = -15,
	
	UI_titanium_list_app_list_appNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all _titanium_list_app_list_app instances of
