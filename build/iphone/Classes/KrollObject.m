 ...
 * Copyright (c) 2009-2011 by _titanium_list_app_list_app, Inc. All Rights Reserved.
...
//@interface _titanium_list_app_list_appObject : NSObject
//@end

@interface _titanium_list_app_list_appObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[_titanium_list_app_list_appObject class]])
		{
			for (NSString *key in [[(_titanium_list_app_list_appObject*)o modules] allKeys])
			{
