...
static NSString * const k_titanium_list_app_list_appJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_titanium_list_appInjection
{
	...
	[html appendString:k_titanium_list_app_list_appJavascript];
...
{
	// attempt to make well-formed HTML and inject in our _titanium_list_app_list_app bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _titanium_list_appInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to _titanium_list_app_list_app support.",url);
				}
			}
